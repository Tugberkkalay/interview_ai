    ...
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-cyan-500 selection:text-black">
      <div className="container mx-auto px-6 py-20 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p>
            Plena AI hizmetlerini kullanarak aşağıdaki koşulları kabul etmiş sayılırsınız. Lütfen dikkatlice okuyunuz.
          </p>

          <h3>1. Hizmetin Tanımı</h3>
          <p>
            Plena AI, yapay zeka destekli mülakat simülasyonu ve aday değerlendirme hizmeti sunan bir SaaS (Software as a Service) platformudur.
          </p>
          ...
          <p>
            Plena AI, bu koşulları dilediği zaman güncelleme hakkını saklı tutar. Değişiklikler sitede yayınlandığı andan itibaren geçerli olur.
          </p>
        </div>
      </div>
    </div>
