        ...
        <section id="features" className="py-32 container mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Sıradan formları unutun. Plena, adaylarınızı ses, görüntü ve duygu analizi ile değerlendiren yeni nesil bir platformdur.
            </p>
          </div>
               ...
               <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div className="font-mono text-xs text-slate-500 bg-black/50 p-4 rounded-lg border border-white/5 mt-4">
                    ...
                    <div className="flex gap-2 pl-4">
                      ...
                      <span className="text-green-400">Plena</span>
                      <span className="text-slate-400">.</span>
          ...
          <div className="container mx-auto px-6">
             <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div className="col-span-1 md:col-span-2">
                    <Link to="/" className="text-3xl font-black tracking-tighter mb-6 block">
                        PLENA<span className="text-white/50">.AI</span>
                    </Link>
             ...
             <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                 <p className="text-slate-600 text-sm">
                   © 2024 Plena AI Inc. Tüm hakları saklıdır.
                 </p>
